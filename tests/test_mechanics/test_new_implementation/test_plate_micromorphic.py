...
class TestMecha(TestCase):
    def test_plate_micromorphic(self):
        # --- VALUES
        u_min = 0.0
        u_max = 0.2
        time_steps: list = list(np.linspace(u_min, u_max, 200, endpoint=True))
        ...
        res_folder_path = get_current_res_folder_path() + "_PLATE_MICROMORPHIC"
