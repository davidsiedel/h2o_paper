...
class TestMecha(TestCase):
    def test_axisymmetric(self):
        ...
        p = Problem(
            ...
            tolerance=1.0e-8,
            res_folder_path=get_current_res_folder_path() + "_incompressible_traction"
        )
        ...
        mat = Material(
            ...
            library_path="behaviour_elasticity_small_strain/src/libBehaviour.so",
