...
class TestMecha(TestCase):
    def test_axisymmetric(self):
        ...
        mesh_file_path = "meshes/rod_half_10.msh"
        ...
        p = Problem(
            ...
            tolerance=1.0e-6,
            res_folder_path=get_current_res_folder_path() + "_AXI_SATOH_INCOMP"
        )
        ...
        mat = Material(
            ...
            library_path="behaviour_fuel_rod_elastic/src/libBehaviour.so",
