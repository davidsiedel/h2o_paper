...
class TestMecha(TestCase):
    def test_notched_specimen_finite_strain_linear_voce_hardening2(self):
        ...
        time_steps = np.linspace(u_min, u_max_comp_diskpp, 30, endpoint=True)
        iterations = 10
        ...
        mesh_file_path = "meshes/SSNA_303_2021_10_27_bis.msh"
        mesh_file_path = "meshes/ssna303_COMP_AXI_on_axis.msh"
        mesh_file_path = "meshes/ssna303_COMP_AXI_TRI.msh"
        ...
        p = Problem(
            ...
            tolerance=1.0e-6,
            res_folder_path=get_current_res_folder_path() + "_COMP_DISKPP_22_TRIS"
        )
        ...
        mat = Material(
            ...
            library_path="bh3/src/libBehaviour.so",
            library_name="Voce",
