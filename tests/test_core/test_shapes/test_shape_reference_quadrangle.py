...
class TestCellQuadrangle(TestCase):
    def test_quadrangle_geometry_cell(self, verbose=True):
        ...
        if verbose:
            ...
            print("-- volume :\n{}".format(v_c))
            for i in range(4):
                plt.scatter(quadrangle_vertices[0, i], quadrangle_vertices[1, i], c="b")
    ...
    def test_quadrangle_quadrature_cell(self, verbose=True):
        ...
        for _io in range(1, 9):
            ...
            # --- GET H20 ESTIMATION
            val_num = 0.0
            triangle_quadrature_points = cell_triangle.get_quadrature_points(_io)
            triangle_quadrature_weights = cell_triangle.get_quadrature_weights(_io)
    ...
    def test_cell_quadrangle(self, verbose=True):
        """
